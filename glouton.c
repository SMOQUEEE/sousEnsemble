...
// void gourmandise(char ** tableau,int N, int K)
// {   
//     int i,j;
//     int cpt;
//     int maxElement = 0;
//     char* test = (char*)  malloc(sizeof(char)*K);

//     char ** sousEnsemble = (char**)  malloc(sizeof(char*)*K);

//     for(i = 0; i < N; i++)
//     {
//         sousEnsemble[i] = (char*) malloc(sizeof(char)* K);
//     }
